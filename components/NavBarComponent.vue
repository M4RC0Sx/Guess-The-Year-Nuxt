<template>
  <nav
    class="flex space-x-4 py-4 mx-2 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-600"
  >
    <div
      class="flex flex-auto items-center justify-between mx-auto p-4 max-w-4xl"
    >
      <ul class="flex items-center list-none">
        <a class="dark:text-gray-200" @click="darkMode = !darkMode">
          <IconMoon
            v-if="darkMode"
            class="w-6 h-6"
            :font-controlled="false"
          ></IconMoon>
          <IconSun v-else class="w-6 h-6" :font-controlled="false"></IconSun>
        </a>
      </ul>
      ...
      <ul class="flex items-center list-none">
        ...
        >
          <IconGitHub class="w-6 h-6" :font-controlled="false" />
        </a>
      </ul>
    </div>
  </nav>
